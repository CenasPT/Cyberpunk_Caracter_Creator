...
Johnny.set_implante_cibernetico("Braço cibernético Cromado")
...
Morgan.set_implante_cibernetico("Braço cibernético Cromado")
...
Alt.set_implante_cibernetico("Ligações de Interface")
...
Saburo.set_implante_cibernetico("?")
...
Smasher.set_implante_cibernetico("Samson frame")
...
Rogue.set_implante_cibernetico("Visão Cibernética")
...
Bartmoss.set_implante_cibernetico("?")
